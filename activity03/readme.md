...
This data package contains the data that powers the chart ["Nuclear power generation"](https://ourworldindata.org/grapher/nuclear-energy-generation?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on February 17, 2026.
